...
This repository hosts the source code of paper of **[Cooperative evolution with reward-based heterogeneous tax in spatial public goods games](https://www.cell.com/iscience/fulltext/S2589-0042(25)00073-2)**, which has been published in iScience.
...
```
@article{yue2025cooperative,
  title={Cooperative evolution with reward-based heterogeneous tax in spatial public goods games},
  author={Yue, Li and Zhang, Huizhen and Sun, Yueyu and An, Tianbo and Wang, Jingrui},
  journal={iScience},
  volume={28},
  number={2},
  year={2025},
